...
public class Trail {
    ...
    public Trail(String img, String title, String subtitle, Float difficulty, Float length, Float duration, String region, String start_pt, String end_pt, Boolean isTarget, String[] tags) {
        this.img = img;
        this.title = title;
